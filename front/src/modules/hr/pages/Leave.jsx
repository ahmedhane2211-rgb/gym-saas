...
const Leave = () => {
    ...
    },
    {
      ...
      render: (leave) => (
        <span className="text-gray-600 dark:text-gray-400 text-xs font-bold">
          {formattedDate(leave.created_at)}
        </span>
      ),
    },
  ];
  ...
  const exportColumns = [
    ...
    { header: "days", key: "days" },
    {
      header: "created_at",
      key: "created_at",
      render: (leave) => formattedDate(leave.created_at),
    },
    { header: "id", key: "id" },
  ];
  ...
  const stats = [
    {
      label: t("total_leaves") || "إجمالي الإجازات",
      value: leaves.length || 0,
      icon: <Calendar className="text-orange" />,
      color: "orange",
    },
  ];
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <SectionTitle title="leaves" description="manage_leaves_desc" t={t} />
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <SearchFilter
          ...
          placeholder={t("search_leaves") || "بحث في الإجازات"}
        />
      ...
      <LeaveModal
        ...
        title={
          editingLeave
            ? t("update_leave") || "تعديل إجازة"
            : t("add_leave") || "إضافة إجازة"
        }
      />
    </div>
  );
