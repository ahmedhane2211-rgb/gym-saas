...
const Employee = () => {
  ...
  const statusEmployees = employees.filter((employee) =>
    activeStatus === "active" ? employee.active : !employee.active,
  );
  const filteredEmployees = useFilter(statusEmployees, searchTerm, [
    "user.full_name",
    "job_number",
    "email",
    "phone",
    ...
    },
    {
      ...
      render: (employee) => (
        <span className="text-gray-600 dark:text-gray-400 text-xs font-bold">
          {formattedDate(employee.date_of_joining)}
        </span>
      ),
    },
    {
  ...
  const exportColumns = [
    {
      ...
      key: "name",
      render: (employee) =>
        employee.name || employee.user?.full_name || employee.user?.name || "",
    },
    { header: "job_number", key: "job_number" },
    {
      header: "email",
      key: "email",
      render: (employee) => employee.email || employee.user?.email || "",
    },
    {
      header: "phone",
      key: "phone",
      render: (employee) => employee.phone || employee.user?.phone || "",
    },
    ...
    { header: "address", key: "address" },
    {
      header: "date_of_joining",
      key: "date_of_joining",
      render: (employee) => formattedDate(employee.date_of_joining),
    },
    ...
    { header: "description", key: "description" },
    {
      header: "created_at",
      key: "created_at",
      render: (employee) => formattedDate(employee.created_at),
    },
    {
      header: "user_id",
      key: "user_id",
      render: (employee) => employee.user_id || employee.user?.id || "",
    },
    { header: "id", key: "id" },
  ];
  ...
  const stats = [
    {
      ...
      icon: <BriefcaseBusiness className="text-orange" />,
      color: "orange",
    },
    {
      label: t("active_employees"),
      value:
        employees.filter((employee) => employee.user?.is_active).length || 0,
