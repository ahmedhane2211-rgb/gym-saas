    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-gray-600 dark:text-gray-500 text-xs font-bold uppercase tracking-widest max-w-md">
            {t("manage_features_desc") ||
              "Define distinct features that can be added to your subscription plans."}
          </p>
        </div>
        <Button
          onClick={() => {
