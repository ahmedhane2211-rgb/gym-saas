...
const SalesInvoice = () => {
  ...
  const addItem = () => {
    ...
    if (existingItemIndex > -1) {
      ...
      const newQuantity =
        existingItem.quantity + (parseInt(currentQuantity) || 0);
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-gray-600 dark:text-gray-500 text-xs font-bold uppercase tracking-widest max-w-md leading-relaxed ml-1">
            {t("create_new_invoice_desc") ||
              "Generate professional sales receipts for gym products and merchandise."}
          </p>
        </div>
      </div>
            ...
            <div className="overflow-x-auto rounded-3xl border border-gray-100 dark:border-white/5">
              <table className="w-full border-collapse">
                <thead className="bg-gray-50 dark:bg-white/5">
                  <tr>
                    <th className="p-4 text-left text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      {t("product")}
                    </th>
                    <th className="p-4 text-center text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      {t("price")}
                    </th>
                    <th className="p-4 text-center text-[10px] font-black text-gray-400 uppercase tracking-widest">
                      {t("quantity")}
                ...
                <tbody>
                  {items.length === 0 ? (
                    <tr>
                      <td
                        colSpan="6"
                        className="p-12 text-center text-gray-400  text-xs uppercase tracking-widest"
                      >
                    ...
                    items.map((item, index) => (
                      <tr
                        key={index}
                        className="border-t border-gray-100 dark:border-white/5 hover:bg-blue/5 transition-colors"
                      >
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                        ...
                        <td className="p-4 text-center">
                          <span className="px-3 py-1 bg-gray-100 dark:bg-white/10 rounded-lg text-xs font-black text-gray-900 dark:text-white">
                            {item.quantity}
                          </span>
                        </td>
                        <td className="p-4 text-center">
                        ...
                        <td className="p-4 text-center text-xs font-black text-blue tracking-tight ">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
                  {t("overall_discount") || "Overall Discount"} (EGP)
                </label>
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-white/5">
                ...
                <button
                  ...
                  className="w-full py-6 bg-gradient-to-r from-blue to-blue/80 hover:from-blue/90 hover:to-blue text-black font-black uppercase  tracking-[0.3em] rounded-[2rem] shadow-xl shadow-blue/20 transition-all active:scale-[0.98] flex items-center justify-center gap-3 overflow-hidden group relative"
                >
                  <span className="relative z-10">
                    {isSubmitting ? t("processing") : t("confirm_invoice")}
                  </span>
                  <ArrowRight
                    size={20}
