  ...
  return (
    <section className="space-y-8">
      <div className="space-y-6">
        <h3 className="text-lg font-black uppercase tracking-widest text-gray-400 italic">{t('invoice_header')}</h3>
      ...
      <div className="space-y-6">
        <h3 className="text-lg font-black uppercase tracking-widest text-gray-400 italic">{t('invoice_footer')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Controller
