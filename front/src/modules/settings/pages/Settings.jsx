...
import { useGetSettingsQuery, useUpdateSettingsMutation } from '../services/SettingsSlice';
...
const Settings = () => {
  ...
  if (isLoading) return <div className="p-8 animate-pulse text-gray-400 font-black uppercase tracking-widest">Loading Settings...</div>;

  return (
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      <div className="space-y-2">
        <h1 className="text-5xl font-black text-gray-900 dark:text-white tracking-widest italic uppercase">{t('settings')}</h1>
        <p className="text-gray-600 dark:text-gray-500 text-xs font-bold uppercase tracking-widest max-w-md leading-relaxed">
          {t('manage_settings_desc') || 'Configure your company details and invoice preferences.'}
        </p>
      </div>
