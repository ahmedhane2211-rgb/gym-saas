...
const OwnerDashboard = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: <ShieldCheck size={32} className="text-blue" />,
    },
    {
      label: t("total_users"),
      value: "---",
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700">
      <div className="space-y-2">
        <h1 className="text-6xl font-black text-gray-900 dark:text-white tracking-tighter  uppercase">
          {t("owner_dashboard")}
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, i) => (
          <div
            key={i}
            className="glass-card p-8 group hover:scale-[1.02] transition-all duration-500 cursor-default"
          >
