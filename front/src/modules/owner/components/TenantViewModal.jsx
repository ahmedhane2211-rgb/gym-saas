...
import { Building2, User, Mail, Globe, Calendar, BadgeCheck, ShieldCheck } from 'lucide-react';
...
const TenantViewModal = ({ isOpen, onClose, tenant }) => {
  ...
  return (
    <AppModal isOpen={isOpen} onClose={onClose} title={t('subscription_details')} maxWidth="max-w-xl" showCloseFooter closeText={t('close')}>
