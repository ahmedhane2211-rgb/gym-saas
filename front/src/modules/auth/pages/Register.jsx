  ...
  return (
    <div className="h-screen w-full flex flex-col md:flex-row bg-dark font-main overflow-x-hidden">
      ...
      <div className="hidden md:flex md:w-[40%] flex-col justify-between p-12 bg-black relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-0 leading-[0.9]">
            ...
            <h2 className="text-5xl font-black text-blue  tracking-tighter">
              PERFORMANCE
            </h2>
          </div>

          <p className="mt-8 text-gray-500 max-w-xs text-sm font-medium leading-relaxed">
            Enter the lab. Register your credentials to begin your
            high-performance tracking journey.
          </p>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="relative w-72 h-80 bg-gray-dark border border-white/5 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 space-y-0.5">
                <span className="text-orange font-black text-3xl block leading-none">
                  001
                </span>
        ...
        <div className="max-w-xl mx-auto w-full">
          ...
          <div className="mb-10 flex justify-between items-start">
            <div className="space-y-1">
              <span className="text-blue text-[10px] font-black tracking-[0.2em] uppercase block">
                New Account
              </span>
            ...
            <div className="text-right">
              ...
              <Link
                to="/login"
                className="text-gray-300 text-xs font-bold hover:text-white transition-colors"
              >
                Sign In
              </Link>
            </div>
          ...
          >
            ...
            <Button
              title={t("register")}
              className="w-full bg-orange hover:bg-orange/90 text-black font-black py-5 rounded-lg tracking-[0.2em] uppercase text-sm shadow-[0_0_30px_rgba(255,95,31,0.2)] transition-all active:scale-[0.99]"
            />
          </form>
        </div>
      </div>
      ...
      <div className="md:hidden absolute bottom-4 right-4 bg-gray-dark px-2 py-1 rounded border border-white/5">
        <span className="text-[8px] font-mono text-orange tracking-widest uppercase">
          System Ready
        </span>
      </div>
    </div>
