...
} from "../services/OwnerWithdrawalsSlice";
...
const OwnerWithdrawals = () => {
  ...
  const [addOwnerWithdrawal, { isLoading: isAdding }] =
    useAddOwnerWithdrawalMutation();
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <SectionTitle title="owner_withdrawals" description="manage_owner_withdrawals" t={t} />
        <Button
